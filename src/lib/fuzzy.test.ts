 ...
 *
 * These are mostly *ranking* tests, written against real names from murphy-yi. A
...
describe('fuzzyMatch', () => {
  ...
  it('ranks a shorter, tighter name above a longer one that also matches', () => {
    const out = rank('redis', [
      'argocd-redis-6f6867546c-7x7gb',
      'csearch-redis-6bb8d4fb9-kcp4z',
      'redis',
    ]);

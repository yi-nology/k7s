/**
 * GPU Monitor dashboard card component. Extracted from gpu-monitor.tsx so that
 * file only exports the plugin definition (react-refresh).
 *
 * Queries `nvidia_gpu_*` / DCGM Prometheus metrics via the provider's
...
export function GpuDashboardCard() {

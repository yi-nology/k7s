...
export const MOCK_PODS: MockPod[] = [
  { name: "valkyrie-api-7d9f8b64d-x2k4n", ns: "prod", ready: "3/3", restarts: 0, cpu: "212m", mem: "486Mi", age: "4d2h", status: "Running", node: "murphy-yi-node-02", containers: ["valkyrie-api", "istio-proxy", "log-shipper"] },
  { name: "valkyrie-api-7d9f8b64d-p9w7z", ns: "prod", ready: "3/3", restarts: 0, cpu: "198m", mem: "471Mi", age: "4d2h", status: "Running", node: "murphy-yi-node-04", containers: ["valkyrie-api", "istio-proxy", "log-shipper"] },
  { name: "bifrost-gateway-5c7dd4f6b-jl2mn", ns: "prod", ready: "2/2", restarts: 1, cpu: "341m", mem: "812Mi", age: "11d", status: "Running", node: "murphy-yi-node-01", containers: ["bifrost-gateway", "istio-proxy"] },
  { name: "yggdrasil-db-0", ns: "prod", ready: "1/1", restarts: 0, cpu: "890m", mem: "3.2Gi", age: "31d", status: "Running", node: "murphy-yi-node-03", containers: ["postgres"] },
  { name: "yggdrasil-db-1", ns: "prod", ready: "1/1", restarts: 0, cpu: "124m", mem: "2.9Gi", age: "31d", status: "Running", node: "murphy-yi-node-05", containers: ["postgres"] },
  { name: "heimdall-auth-6b8c9d5f7-qq3rt", ns: "prod", ready: "1/2", restarts: 14, cpu: "45m", mem: "203Mi", age: "2h14m", status: "CrashLoopBackOff", node: "murphy-yi-node-02", containers: ["heimdall-auth", "istio-proxy"] },
  { name: "mimir-cache-7f4b8c6d9-ab8cd", ns: "prod", ready: "1/1", restarts: 0, cpu: "67m", mem: "1.1Gi", age: "11d", status: "Running", node: "murphy-yi-node-04", containers: ["redis"] },
  ...
  { name: "loki-runner-6d9f7b8c5-tt4vw", ns: "staging", ready: "1/1", restarts: 2, cpu: "88m", mem: "340Mi", age: "3d", status: "Running", node: "murphy-yi-node-06", containers: ["loki-runner"] },
  { name: "prometheus-server-0", ns: "monitoring", ready: "2/2", restarts: 0, cpu: "512m", mem: "2.4Gi", age: "31d", status: "Running", node: "murphy-yi-node-01", containers: ["prometheus", "config-reloader"] },
  { name: "grafana-5f8d7c6b9-mm1xz", ns: "monitoring", ready: "1/1", restarts: 0, cpu: "34m", mem: "187Mi", age: "31d", status: "Running", node: "murphy-yi-node-06", containers: ["grafana"] },
  { name: "coredns-76f75df574-8rk2j", ns: "kube-system", ready: "1/1", restarts: 0, cpu: "12m", mem: "31Mi", age: "31d", status: "Running", node: "murphy-yi-node-01", containers: ["coredns"] },
  { name: "kube-proxy-x9d4m", ns: "kube-system", ready: "1/1", restarts: 0, cpu: "8m", mem: "24Mi", age: "31d", status: "Running", node: "murphy-yi-node-02", containers: ["kube-proxy"] },
];
...
export const MOCK_CLUSTERS = [
  { name: "murphy-yi", env: "prod", active: true },
...
export const MOCK_RESOURCES: Partial<Record<ResourceKind, RawRow[]>> = {
  ...
  ingresses: [
    R("api-public", "prod", ["api.murphy-yi.io", "nginx", "31d"]),
    R("grafana", "monitoring", ["grafana.murphy-yi.internal", "nginx", "31d"]),
  ],
  configmaps: [
  ...
  secrets: [
    ...
    R("tls-api-murphy-yi-io", "prod", ["kubernetes.io/tls", "2", "12d"]),
    R("registry-pull", "prod", ["dockerconfigjson", "1", "31d"]),
  ],
  nodes: [
    R("murphy-yi-node-01", "", ["Ready", "control-plane", "38%", "61%", "v1.31.2"], { ok: true }),
    R("murphy-yi-node-02", "", ["Ready", "worker", "52%", "74%", "v1.31.2"], { ok: true }),
    R("murphy-yi-node-03", "", ["Ready", "worker", "71%", "82%", "v1.31.2"], { ok: true }),
    R("murphy-yi-node-04", "", ["Ready", "worker", "44%", "58%", "v1.31.2"], { ok: true }),
    R("murphy-yi-node-05", "", ["Ready", "worker", "29%", "66%", "v1.31.2"], { ok: true }),
    R("murphy-yi-node-06", "", ["Ready", "worker", "12%", "39%", "v1.31.2"], { ok: true }),
  ],
  namespaces: [
...
const MOCK_EVENTS: {
  ...
  { type: "Normal", reason: "Scheduled", object: "Pod/valkyrie-api-6c8d9-mn4p", ns: "prod", age: "4m", count: 1, message: "Successfully assigned prod/valkyrie-api-6c8d9-mn4p to murphy-yi-node-02" },
  { type: "Normal", reason: "Pulled", object: "Pod/valkyrie-api-6c8d9-mn4p", ns: "prod", age: "4m", count: 1, message: "Container image \"registry.murphy-yi.io/valkyrie-api:2.14.0\" already present on machine" },

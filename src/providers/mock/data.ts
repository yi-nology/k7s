...
export const MOCK_PODS: MockPod[] = [
  {
    name: 'valkyrie-api-7d9f8b64d-x2k4n',
    ns: 'prod',
    ready: '3/3',
    restarts: 0,
    cpu: '212m',
    ...
    age: '4d2h',
    status: 'Running',
    node: 'murphy-yi-node-02',
    containers: ['valkyrie-api', 'istio-proxy', 'log-shipper'],
  },
  {
    name: 'valkyrie-api-7d9f8b64d-p9w7z',
    ns: 'prod',
    ready: '3/3',
    restarts: 0,
    cpu: '198m',
    ...
    age: '4d2h',
    status: 'Running',
    node: 'murphy-yi-node-04',
    containers: ['valkyrie-api', 'istio-proxy', 'log-shipper'],
  },
  {
    name: 'bifrost-gateway-5c7dd4f6b-jl2mn',
    ns: 'prod',
    ready: '2/2',
    restarts: 1,
    cpu: '341m',
    ...
    age: '11d',
    status: 'Running',
    node: 'murphy-yi-node-01',
    containers: ['bifrost-gateway', 'istio-proxy'],
  },
  {
    name: 'yggdrasil-db-0',
    ns: 'prod',
  ...
  },
  {
    ...
    node: 'murphy-yi-node-02',
    containers: ['heimdall-auth', 'istio-proxy'],
  },
  {
    name: 'mimir-cache-7f4b8c6d9-ab8cd',
    ns: 'prod',
    ready: '1/1',
    restarts: 0,
    cpu: '67m',
  ...
  {
    name: 'valkyrie-api-canary-89f7c5d4b-nn2kp',
    ns: 'staging',
    ready: '0/3',
    restarts: 0,
    cpu: '—',
  ...
  {
    name: 'loki-runner-6d9f7b8c5-tt4vw',
    ns: 'staging',
    ready: '1/1',
    restarts: 2,
    cpu: '88m',
    ...
    age: '3d',
    status: 'Running',
    node: 'murphy-yi-node-06',
    containers: ['loki-runner'],
  },
  {
...
const R = (
  ...
  ns: string,
  c: string[],
  flags: { ok?: boolean; warn?: boolean } = {}
): RawRow => ({ name, ns, c, ...flags });
...
const MOCK_EVENTS: {
...
}[] = [
  {
    type: 'Warning',
    reason: 'BackOff',
    object: 'Pod/heimdall-auth-7d9f4-x2k1',
    ns: 'prod',
    age: '12s',
    count: 41,
    message: 'Back-off restarting failed container auth in pod heimdall-auth-7d9f4-x2k1',
  },
  {
    type: 'Warning',
    reason: 'FailedScheduling',
    object: 'Pod/valkyrie-api-canary-5b8-qq7z',
    ns: 'staging',
    age: '38s',
    count: 9,
  ...
  },
  {
    type: 'Warning',
    reason: 'FailedMount',
    object: 'Pod/report-gen-28661-lx4d',
    ns: 'prod',
    age: '6h',
    count: 2,
    message: 'MountVolume.SetUp failed for volume "reports": timed out waiting for the condition',
  },
  {
    type: 'Normal',
    reason: 'Scheduled',
    object: 'Pod/valkyrie-api-6c8d9-mn4p',
    ns: 'prod',
    age: '4m',
    count: 1,
    message: 'Successfully assigned prod/valkyrie-api-6c8d9-mn4p to murphy-yi-node-02',
  },
  {
    type: 'Normal',
    reason: 'Pulled',
    ...
    count: 1,
    message:
      'Container image "registry.murphy-yi.io/valkyrie-api:2.14.0" already present on machine',
  },
  {
    type: 'Normal',
    reason: 'Created',
  ...
  },
  {
    ...
    object: 'Job/report-gen-28661',
    ns: 'prod',
    age: '6h',
    count: 1,
    message: 'Created pod: report-gen-28661-lx4d',
  },
  {
    type: 'Normal',
    reason: 'ScalingReplicaSet',
    object: 'Deployment/valkyrie-api',
    ns: 'prod',
    age: '4d2h',
    count: 1,
    message: 'Scaled up replica set valkyrie-api-6c8d9 to 2',
  },
];

...
export function eventsForPodName(name: string | null): EventItem[] {
  ...
  if (pod.status === "CrashLoopBackOff") {
    return [
      ...
      { type: "Normal", reason: "Pulled", age: "2h", count: 1, message: 'Container image "registry.murphy-yi.io/heimdall-auth:v2.4.1" already present on machine' },
  ...
  return [
    ...
    { type: "Normal", reason: "Pulled", age: pod.age, count: 1, message: `Container image "registry.murphy-yi.io/${containers[0]}:v2.4.1" already present on machine` },

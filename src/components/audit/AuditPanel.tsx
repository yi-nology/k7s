    ...
    <div style={panelStyle}>
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        <aside style={sideStyle}>
          ...
          <button type="button" style={{ ...btnStyle, marginTop: 4 }} onClick={() => setShowAdd(!showAdd)}>
            {showAdd ? t("chrome.common.cancel", "Cancel") : t("audit.add", "Add Loki…")}
          </button>
          {showAdd && (
            <div style={{ marginTop: 4 }}>
              <input placeholder="Name" value={addName} onChange={(e) => setAddName(e.target.value)} style={inputStyle} />
              <input placeholder="URL" value={addUrl} onChange={(e) => setAddUrl(e.target.value)} style={inputStyle} />
              <input placeholder="Username" value={addUser} onChange={(e) => setAddUser(e.target.value)} style={inputStyle} />
              <input placeholder="Password" type="password" value={addPass} onChange={(e) => setAddPass(e.target.value)} style={inputStyle} />

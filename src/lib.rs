...
pub fn run() {
    ...
    // Split handler registration by platform: desktop includes CLI-dependent
    // commands; Android omits them to avoid dead code in the binary.
    ...
    let builder = builder.invoke_handler(tauri::generate_handler![
        // ---- common commands (no desktop CLI dependencies) ----
        commands::list_contexts,
        commands::default_kubeconfig_path,
        commands::import_kubeconfig,
        commands::restore_imports,

# Handoff: K8s Monitor ("murphy-yi") — Tauri + Rust desktop app
...
- Left: breadcrumb mono 12px — `murphy-yi / <group> / <Kind>`; separators `#3a3a42`, kind `#ececf1` semibold, rest `#70707a`.
...
Mono 10px `#70707a`: `● murphy-yi` (green), api latency, nodes ready, cpu %, mem %; right-aligned `kubectl ctx: <context>`.
